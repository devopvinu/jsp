...
int totalAbsentees = girlsAbsentCount + boysAbsentCount;
   ...
   try {
      ...
      PreparedStatement stmt = con.prepareStatement("INSERT INTO mba (girls,boys,subject, topic, tdate, lecture, gab, bab, tot) VALUES (?, ?, ?, ?, ?, ?, ?,?,?)");
      ...
      out.println("<script> window.location.href='mba.jsp';</script>");
   } catch (Exception e) {
      e.printStackTrace();
